// IFT3100H25_CurveHermite/application.cpp
...
void Application::keyReleased(int key)
{
  switch(key)
  {
    ...
    case 53: // touche 5
      ofLog() << "<select curve type : hermite>";
      renderer.curve_name = "Hermite cubique";
      renderer.curve_type = CurveType::hermite;
      break;

    case 54: // touche 6
      ofLog() << "<select curve type : bezier cubic>";
      renderer.curve_name = "Bézier cubique";
